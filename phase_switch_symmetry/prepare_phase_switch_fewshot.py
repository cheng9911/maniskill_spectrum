...
SAMPLE_SIZES = [3, 5, 8, 10, 15, 20, 30]
...
def main():
    ...
    if len(contexts) != 30:
        raise RuntimeError("few-shot manifest requires 30 fixed mixed contexts")
    ...
    output = {
        "schema_version": 1,
        "status": "frozen_before_fewshot_fitting",
    ...
    output_path = args.experiment.parent / "fewshot_subsets.json"
