...
def main():
    ...
    if len(contexts) != 30:
        raise RuntimeError("symmetry-transfer manifest requires 30 fixed mixed contexts")
    ...
    output = {
        "schema_version": 1,
        "status": "frozen_before_symmetry_transfer_fitting",
    ...
    output_path = args.experiment.parent / "symmetry_transfer_subsets.json"
