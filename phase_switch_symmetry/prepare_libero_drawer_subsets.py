...
"""Freeze rank-6 few-shot subsets for the LIBERO drawer relation probe."""
...
def main():
    ...
    output = {
        "schema_version": 1,
        "status": "frozen_before_libero_drawer_fitting",
        ...
        "policies": {
            ...
            "rank_6_required_for_all_qualified_subsets": True,
        },
        "subsets": subsets,
    }
    output_path = args.experiment.parent / "libero_drawer_subsets.json"
